...
gsKyari1= client.open('Kyari Advertisment SP,SD&SB(July-Sep2023)')
kyarisheet1=gsKyari1.worksheet('SP&SD')
kyari_all_record1=kyarisheet1.get_all_records()
kyari_spend1=pd.DataFrame(kyari_all_record1)
gsKyari2= client.open('Kyari Advertisment SP,SD&SB(Feb-June2023)')
kyarisheet2=gsKyari2.worksheet('SP&SD')
kyari_all_record2=kyarisheet2.get_all_records()
kyari_spend2=pd.DataFrame(kyari_all_record2)
...
kyari_spend=pd.concat([kyari_spend1,kyari_spend2],ignore_index=False)
...
kyarisbsheet1=gsKyari1.worksheet('SB')
sb_all_record1=kyarisbsheet1.get_all_records()
sb_df1=pd.DataFrame(sb_all_record1)
kyarisbsheet2=gsKyari2.worksheet('SB')
sb_all_record2=kyarisbsheet2.get_all_records()
sb_df2=pd.DataFrame(sb_all_record2)
sb_df=pd.concat([sb_df1,sb_df2],ignore_index=False)
